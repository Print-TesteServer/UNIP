...
public class Exemplo083 extends JFrame implements ActionListener 
{
   JButton B1, B2, B3;
   ...
   public Exemplo083()
   {
      ...
      L1 = new JLabel("EXCLUSÃO DOS DADOS DO ALUNO");
   ...
   {
      new Exemplo083().setVisible(true);
   }
